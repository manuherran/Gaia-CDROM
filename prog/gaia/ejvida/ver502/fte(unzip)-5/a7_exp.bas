...
'Opciones
Global repulsion_exp As Boolean
Global compartir_mapas_exp As Boolean

Sub s_inicializar_ejemplo_elegido_exp()
    ...
    Select Case num_ej_activo_ejv
        ...
        'ESPECIFICAS DE EXPLORANDO MAPAS
...
End Sub
Sub s_grabar_opciones_exp()

    '1 Jugadores se repelen
    If frm_a7_opexp.Op_Repulsion = 1 Then
        repulsion_exp = True
    Else
        repulsion_exp = False
    End If
    '2 Compartir mapas
    If frm_a7_opexp.Op_CompartirMapas = 1 Then
        compartir_mapas_exp = True
    Else
        compartir_mapas_exp = False
    End If

End Sub

Sub s_cargar_opciones_exp()

    '1 Jugadores se repelen
    If repulsion_exp Then
        frm_a7_opexp.Op_Repulsion = 1
    Else
        frm_a7_opexp.Op_Repulsion = 0
    End If
    '2 Compartir mapas
    If compartir_mapas_exp Then
        frm_a7_opexp.Op_CompartirMapas = 1
    Else
        frm_a7_opexp.Op_CompartirMapas = 0
    End If


End Sub
Sub s_mostrar_info_exp()


End Sub
Sub s_grabar_resumen_exp()
    ...
    For i = 1 To num_tipos_agentes_va0
        linea = linea & ";" & f_comillas(CStr(num_agentes_tipo_va0(i))) ' los 2 bichos
    Next i
